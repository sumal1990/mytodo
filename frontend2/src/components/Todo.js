...
function Todo() { 
	...
	useEffect(() => { 
		axios.get('https://frontend-todo-back.onrender.com/getTodoList') 
			.then(result => { 
	...
	const addTask = (e) => { 
		...
		axios.post('https://frontend-todo-back.onrender.com/addTodoList', { task: newTask, status: newStatus, deadline: newDeadline }) 
			.then(res => { 
				console.log(res); 
	...
	const saveEditedTask = (id) => { 
		...
		axios.post('https://frontend-todo-back.onrender.com/updateTodoList/' + id, editedData) 
			.then(result => { 
				console.log(result); 
				setEditableId(null); 
				setEditedTask(""); 
	...
	const deleteTask = (id) => { 
		axios.delete('https://frontend-todo-back.onrender.com/deleteTodoList/' + id) 
			.then(result => { 
				console.log(result); 
				window.location.reload(); 
			}) 
